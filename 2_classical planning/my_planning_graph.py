...
class ActionLayer(BaseActionLayer):
    ...
    def _inconsistent_effects(self, actionA, actionB):
        ...
        return any([~e in self.children[actionA] for e in self.children[actionB]] +
                   [~e in self.children[actionB] for e in self.children[actionA]])
    ...
    def _interference(self, actionA, actionB):
        ...
        """
        # TODO: implement this function
        return any([~e in self.parents[actionA] for e in self.children[actionB]]) or \
               any([~e in self.parents[actionB] for e in self.children[actionA]])
        #raise NotImplementedError
...
class LiteralLayer(BaseLiteralLayer):
    ...
    def _inconsistent_support(self, literalA, literalB):
        ...
        """
        # TODO: implement this function
        return all(self.parent_layer.is_mutex(actionA,actionB) for actionA in self.parents[literalA] for \
                   actionB in self.parents[literalB])
        #raise NotImplementedError
...
class PlanningGraph:
    ...
    def h_maxlevel(self):
        ...
        #Different method
        #Kept to try at a later stage
        # cost = 0
        # for g in self.goal: #foreach goal
        #     cost=max(cost,self.find_goal(g))
        # return cost
